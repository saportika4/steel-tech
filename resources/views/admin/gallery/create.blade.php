...
<div class="panel">
    <div class="flex items-center justify-between mb-5">
        <h5 class="font-semibold text-lg dark:text-white-light">Add Gallery Image</h5>
...
$(document).ready(function () {
    $('#createGalleryForm').on('submit', function(e) {
        ...
        submitBtn.prop('disabled', true).html('<span class="animate-spin border-2 border-white border-l-transparent rounded-full w-5 h-5 inline-block align-middle mr-2"></span>Uploading...');
